...
def draw_landmarks(image, landmarks):
    ...
    if len(landmark_point) > 0:
        ...
        # 上唇の中央と下唇の中央に点を打つ
        cv.circle(image, landmark_point[13], 2, (0, 0, 255), 2)
        cv.circle(image, landmark_point[14], 2, (255, 0, 0), 2)

        # mouth_points = np.array([landmark_point[13], landmark_point[14]])
        ...
        cv.circle(image, center(mouth_points), 2, (0, 255, 255), 2)
